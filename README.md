...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymodulon-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12788&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymodulon-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymodulon` can be installed with:

```
conda install pymodulon
```

It is possible to list all of the versions of `pymodulon` available on your platform with:
